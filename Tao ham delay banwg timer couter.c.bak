...
void delay(unsigned int t)
{
	do{
		...
		TL0 = 0X18;	 
		TH0 = 0xfc;		  //=.64536 => Thanh ghi 16 bit co gia tri toi da 65536, 100 xung nhip thuc chip thuc hien trong 1ms

		TR0=1;//Khoi dong timer0
		while(TF0!=0);// co chan bo nho bang 1
		TR0=1;//dong lai timer0
		t--;
	}  while(t>0);
}
